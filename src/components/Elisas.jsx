    ...
    <div className="modal" onClick={onClose}>
      <div className="modal-content" onClick={(e) => e.stopPropagation()}>
        ...
        <form>
          <select
            value={estatusElisa}
            onChange={(e) => setEstatusElisa(e.target.value)}
            className="input"
          >
          ...
          <select
            value={lavoElisa}
            onChange={(e) => setLavoElisa(e.target.value)}
            className="input"
          >
          ...
          <select
            value={lugarProceso}
            onChange={(e) => setLugarProceso(e.target.value)}
            className="input"
          >
  ...
  const filterRecords = useCallback(() => {
    return preventixRecords.filter((record) => {
      ...
      const searchTermMatch =
        ...
        record.numeroPlaca?.toLowerCase().includes(searchTerm);
